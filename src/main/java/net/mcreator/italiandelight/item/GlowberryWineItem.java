...
import net.mcreator.italiandelight.procedures.GlowberryWinePlayerFinishesUsingItemProcedure;
...
public class GlowberryWineItem extends Item {
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		GlowberryWinePlayerFinishesUsingItemProcedure.execute(entity);
		return retval;
	}
}
